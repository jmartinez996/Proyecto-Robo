...
import plantillaResumenMensual from "../../../assets/plantillas/plantillaResumenMensual.xls";
import plantillaResumen from "../../../assets/plantillas/plantillaResumenMensual.xls";
...
export default function ResumenMensual(props) {
  ...
  const onSubmit = (data) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .post(`http://10.13.18.84:5000/ejecutaRobotResMens/`, f, {
            headers: {
  ...
  function DescargaPlantilla() {
    ...
    link.href = plantillaResumen;
    link.download = "Plantilla Resumen Mensual.xls";
                ...
                <div className={classes.paper}>
                  ...
                  >
                    ...
                    <Controller
                      ...
                      rules={{
                        required: "El campo Contrasena mixtos esta vacío",
                      }}
                    />
                    <Controller
                      name="user_familia"
                    ...
                    <Controller
                      ...
                      rules={{
                        required: "El campo Contrasena familia esta vacío",
                      }}
                    />
                    <Controller
                      name="user_siagj"
                    ...
                    <Controller
                      ...
                      rules={{
                        required: "El campo Contrasena siagj esta vacío",
                      }}
                    />
                    <Typography variant="inherit" color="error">
                      {errMssg}
