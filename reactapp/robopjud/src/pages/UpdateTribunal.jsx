				...
				<div className={classes.paper}>
					...
					<form className={classes.form} onSubmit={handleSubmit(onSubmit)} encType='application/json'>
						<Controller
							...
							render={({ field: { onChange, value }, fieldState: { error } }) => <TextField variant='outlined' margin='dense' fullWidth id='nombre' value={value} error={!!error} helperText={error ? error.message : null} label='' autoComplete='Nombre de Tribunal' autoFocus onChange={onChange} />}
							rules={{
						...
						<Controller
							...
							render={({ field: { onChange, value }, fieldState: { error } }) => <TextField variant='outlined' margin='dense' fullWidth id='telefono' value={value} error={!!error} helperText={error ? error.message : null} label='' autoComplete='Telefono Tribunal' onChange={onChange} />}
							rules={{
